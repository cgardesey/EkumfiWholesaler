...
import static com.ekumfi.wholesaler.activity.WholesalerAccountActivity.realmWholesaler;
...
public class WholesalerAccountFragment3 extends MultiPickerWrapperSupportFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View rootView = inflater.inflate(R.layout.fragment_wholesaler_account3, container, false);
    ...
    public void init() {
        if (realmWholesaler != null) {
            String picture = realmWholesaler.getIdentification_image_url();
            boolean pictureExists = picture != null;
            if (pictureExists) {
                Glide.with(getContext())
                        .load(realmWholesaler.getIdentification_image_url())
            ...
            identification_type_spinner.setSelection(((ArrayAdapter) identification_type_spinner.getAdapter()).getPosition(realmWholesaler.getIdentification_type()));
            identification_number.setText(realmWholesaler.getIdentification_number());
        }
    }
    ...
    public boolean validate() {
        ...
        if (identification_image.getDrawable() == null && realmWholesaler.getIdentification_image_url() == null) {
