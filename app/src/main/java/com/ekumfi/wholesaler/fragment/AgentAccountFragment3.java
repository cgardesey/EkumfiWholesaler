...
import static com.ekumfi.wholesaler.activity.AgentAccountActivity.realmAgent;
...
public class AgentAccountFragment3 extends MultiPickerWrapperSupportFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View rootView = inflater.inflate(R.layout.fragment_agent_account3, container, false);
    ...
    public void init() {
        if (realmAgent != null) {
            String picture = realmAgent.getIdentification_image_url();
            boolean pictureExists = picture != null;
            if (pictureExists) {
                Glide.with(getContext())
                        .load(realmAgent.getIdentification_image_url())
            ...
            identification_type_spinner.setSelection(((ArrayAdapter) identification_type_spinner.getAdapter()).getPosition(realmAgent.getIdentification_type()));
            identification_number.setText(realmAgent.getIdentification_number());
        }
    }
    ...
    public boolean validate() {
        ...
        if (identification_image.getDrawable() == null && realmAgent.getIdentification_image_url() == null) {
