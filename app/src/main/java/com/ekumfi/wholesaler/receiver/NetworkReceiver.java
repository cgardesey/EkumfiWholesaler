...
//                guidCheck(activeActivity);
                ...
                if (networkAvailable != PreferenceManager.getDefaultSharedPreferences(context).getBoolean("com.ekumfi.wholesaler" + CONNECTEDTONETWORK, false)) {
        ...
        PreferenceManager
                ...
                .edit()
                .putBoolean("com.ekumfi.wholesaler" + CONNECTEDTONETWORK, networkAvailable)
                .apply();
    }
}
