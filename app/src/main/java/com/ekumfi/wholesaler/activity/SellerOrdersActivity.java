...
import com.ekumfi.wholesaler.pagerAdapter.SellerOrdersPagerAdapter;
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(
                    ...
                    public Map getHeaders() throws AuthFailureError {
                        ...
                        headers.put("Authorization", "Bearer " + PreferenceManager.getDefaultSharedPreferences(SellerOrdersActivity.this).getString("com.ekumfi.wholesaler" + APITOKEN, ""));
                        return headers;
                    }
                };
